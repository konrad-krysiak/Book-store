...
class InformationControllerTest < ActionController::TestCase
  ...
  test "should create information" do
    assert_difference('Information.count') do
      post :create, information: { book_id: @information.book_id, content: @information.content, title: @information.title }
    end
  ...
  test "should update information" do
    patch :update, id: @information, information: { book_id: @information.book_id, content: @information.content, title: @information.title }
    assert_redirected_to information_path(assigns(:information))
  end
